...
- uic-app-api (backend Node/Express para Web Push)

Uso recomendado:
1) Crear 2 repos en GitHub (tecnolok-2025):
   - uic-app-pwa
   - uic-app-api
2) Subir cada carpeta a su repo (GitHub Desktop).
3) Render:
   - API como Web Service
